...
export function Chest(props: JSX.IntrinsicElements['group']) {
  ...
  const normalTexture = useTexture('/img/normal1.png')
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[0.026, 1.681, 0.13]} rotation={[0.035, 0, 0]} scale={[0.778, 0.902, 0.295]}>
        ...
        <mesh castShadow receiveShadow geometry={nodes.Sphere003_2.geometry}>
          <meshStandardMaterial attach='material' color='#D3E3DC' normalMap={normalTexture} />
        </mesh>
